// Напиши функциональный компонент "Basic02_Toggle", который возвращает круг в виде элемента <div> с css-классом `.circle`, размером 10rem по высоте и ширине, так же он серого цвета (yellow, применяй rgb код)
